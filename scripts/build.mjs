...
await fs.writeFile(path.join(dist,'manifest.webmanifest'),JSON.stringify({name:site.name,short_name:'Nexo',start_url:site.base,scope:site.base,display:'browser',theme_color:'#5a1830',background_color:'#f6efe8',icons:[{src:`${site.base}assets/favicon.svg`,sizes:'any',type:'image/svg+xml'}]},null,2))
